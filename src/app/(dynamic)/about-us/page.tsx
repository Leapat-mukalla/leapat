      ...
      <div className="mb-[232px] flex flex-col items-center">
        ...
        <div className="min-w-full max-w-[1030px] text-center">
          <p className="mb-24 py-3 text-2xl font-medium text-white">
            ”ليبات“ مبادرة شبابية تقنية تأسست مطلع عام 2024، نسعى لتحقيق قفزات رقمية ملموسة
            يقودها الشباب المبتكر. نهدف إلى تعزيز ثقافة الابتكار والتعاون بين الشباب لمعالجة
            القضايا الملحة وتحقيق تأثير مستدام في مجالات الصحة، البيئة، التعليم، الفن، والثقافة.
            نسعى لبناء مجتمع أكثر وعياً وعدالة من خلال توفير الموارد والإرشاد وتطوير مهارات الشباب.
          </p>
        </div>
      </div>
